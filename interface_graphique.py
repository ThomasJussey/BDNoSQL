...
#canvas = Canvas(Frame2, width=200, height=630)
#canvas.pack(pady=20)
panneau_horizontal.add(Checkbutton(fenetre, text="Poids",variable=variable_bouton_cocher))
panneau_horizontal.add(Button(panneau_horizontal,text ='Calculer',command=lambda :display_voisin(valeur_proteine,variable_bouton_cocher,Frame2,combobox_proteine), width = 10))
panneau_horizontal.pack()




def display_voisin(valeur_proteine,var_poids,frame,combo):
    if var_poids.get() == 0 :
